...
#' 
#' @param Y_new Value of predicted biomarker, used to numerically calculate the density
...
#' @keywords internal
conditionalYTBio = function(Y_all, time_new, bio_i, data.predict.all, 
  ...
  Sigma_all <- lapply(as.numeric(unlist(unique(data.long[[1]][num]))), BJM:::process_variance, 
